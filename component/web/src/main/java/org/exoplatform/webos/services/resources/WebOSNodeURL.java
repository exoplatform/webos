 ...
 *
 */
public class WebOSNodeURL extends NodeURL
{
   ...
   public WebOSNodeURL(URLContext context) throws NullPointerException
   {
      super(context);
   }
   ...
   {
      if (SiteType.USER.equals(getResource().getSiteType())) 
      {
         if (paramNames == null)
         {
